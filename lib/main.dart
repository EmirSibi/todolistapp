...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ListRandomPage(title: 'Random To Do List uygulaması.'),
    );
  }
}
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  leading: Checkbox(
                    ...
                    activeColor: Color.fromARGB(255, 51, 255, 0),
                  ),
                  title: Text(
                    element.toString(),
                    style: TextStyle(
                      color: _tikli[index]
                          ? Color.fromARGB(255, 247, 6, 6)
          ...
          Container(
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                  primary: Color.fromARGB(255, 44, 252, 2)),
              child: const Text('Random Liste oluştur.'),
              onPressed: _olustur,
            ),
          ),
        ],
